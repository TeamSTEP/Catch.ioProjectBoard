<template>
    <scroll-snap :fullscreen="true">
        <MastHead class="item" />
        <section class="bg-white border-b py-8 item">
        ...
        <section class="bg-gray-100 py-8 item">
...
import MastHead from '@/views/sections/MastHead.vue';
