  ...
  <Background color="bg-primary-900">
    <Section>
      <CenteredFooter
        ...
        iconList={(
          <>
            <a
              target="_blank"
              href="https://github.com/TeamSTEP"
            ...
            <a
              target="_blank"
              href="https://www.youtube.com/channel/UC8NXPq0Zd2ueAJ6r6vhhXfw"
              rel="noopener noreferrer"
            >
            ...
            <Link href="mailto:info@teamstep.io">
              <a>
                <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      ...
      >
        ...
        <li>
          <a target="_blank" href="https://gdd.witchone.io/" rel="noopener noreferrer">
            About
          </a>
        </li>
        <li>
